...
connection_str = "Endpoint=sb://ihsuprodnorwayeastres005dednamespace.servicebus.windows.net/;SharedAccessKeyName=iothubowner;SharedAccessKey=HXGrSGiuckF2KOT8bIgF0lU74tAQ3LgQpAIoTBaDygc=;EntityPath=iothub-ehub-myiothubjd-55642258-0e5b9ef559"
consumer_group = "webconsumer"
df = pd.DataFrame({
